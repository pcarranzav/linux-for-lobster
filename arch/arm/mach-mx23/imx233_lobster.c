...
static void __init imx233_lobster_init_adc(void)
{
...
static void __init imx233_lobster_init_machine(void)
{
	mx23_pinctrl_init();
	...
	mx23_gpio_init();
	imx233_lobster_pins_init();
	mx23_device_init();
	imx233_lobster_device_init();
}

MACHINE_START(IMX233_LOBSTER, "The amazing iMX233 LobsterBoard")
	.phys_io	= 0x80000000,
